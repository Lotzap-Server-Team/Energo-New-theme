...
import {  getCountries , getCountryStates , updateCity , getCity } from 'src/redux/store/reducers/slices/UserSlice';
...
function getCityById(){
  const  cityId = window.location.href.split('/')[5] ; 
                  ...
                  <Grid container spacing={2} rowSpacing={1}>
                    <Grid item xs={6} sm={6} mt={2}>
                      ...
                      <Grid item xs={12} sm={6} sx={{ mb: 1 }}>
                        ...
                        />
                        {dirtyFields['name'] && getError('City is requried')}
                      </Grid>
